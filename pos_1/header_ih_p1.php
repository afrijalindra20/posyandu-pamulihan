        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php echo isActive('ibuhamil_p1.php'); ?>" href="../posyandu_1/ibuhamil_p1.php"><i class="fas fa-female"></i> Data Ibu Hamil</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo isActive('ibuhamil_daftar_p1.php'); ?>" href="../posyandu_1/ibuhamil_daftar_p1.php"><i class="fas fa-user-edit"></i> Daftar Ibu Hamil</a>
                    </li>
                    <li class="nav-item">
