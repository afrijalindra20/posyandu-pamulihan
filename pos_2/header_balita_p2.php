        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php echo isActive('balita_p2.php'); ?>" href="../posyandu_2/balita_p2.php"><i class="fas fa-baby"></i> Data Balita</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo isActive('balita_daftar_p2.php'); ?>" href="../posyandu_2/balita_daftar_p2.php"><i class="fas fa-user-edit"></i> Daftar Balita</a>
                    </li>
                    <li class="nav-item">
